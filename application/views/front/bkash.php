        ...
        <div class="container">
            ...
            <div class="row registerAreaContents">
                ...
                <div class="col-md-7 formWrapper paynow-box">
                    <h6>Make your payment in this number through any bKash Customer Wallet<br />আপনি আপনার বিকাশ ওয়ালেট থেকে নিচের নাম্বারে টাকা পাঠান</h6>
                    ...
                    ?>
                    <form action="<?php echo base_url() ?>payment-with-bkash" method="POST" novalidate="">
                        ...
                        <div class="form-group">                                             
                            <div class="row">  
                                ...
                                <div class="col-sm-4"> 
                                    <label class="mylabel">Enter bKash TrxId: </label><br />
