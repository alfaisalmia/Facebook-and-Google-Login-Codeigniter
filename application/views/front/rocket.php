        ...
        <div class="container">
            ...
            <div class="row registerAreaContents">
                ...
                <div class="col-md-7 formWrapper paynow-box">
                    <h6>Make your payment in this number through any Rocket Customer Wallet<br />আপনি আপনার রকেট  ওয়ালেট থেকে নিচের নাম্বারে টাকা পাঠান</h6>
                    ...
                    ?>
                    <form action="<?php echo base_url() ?>payment-with-rocket" method="POST" novalidate="">
                        ...
                        <div class="form-group">                                             
                            <div class="row">  
                                ...
                                <div class="col-sm-4"> 
                                    <label class="mylabel">Enter Rocket TrxId: </label><br />
                    ...
                    ১। *২৪৭# ডায়াল করে রকেট  মোবাইল মেন্যুতে যান<br />

                    ২। “সেন্ড মানি” সিলেক্ট করুন<br />

                    ৩। আপনি যে রকেট  একাউন্টে টাকা পাঠাতে চান সেই একাউন্ট নাম্বারটি লিখুন<br />
                    ...
                    ৬। আপনার রকেট  মোবাইল মেন্যু পিনটি দিয়ে লেনদেনটি সম্পন্ন করুন<br />

                    আপনি এবং প্রাপক দুজনই রকেট  থেকে কনফার্মেশন মেসেজ পাবেন।
                    </div>
